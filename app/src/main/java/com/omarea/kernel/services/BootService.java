package com.omarea.kernel.services;
...
import com.omarea.kernel.utils.IOUtils;
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (RootTools.isAccessGiven()) {
            ...
            if (applyOnBootSet != null) {
                ...
                if (applyOnBootSet.contains(getString(R.string.cpu))) {
                    String max, min, gov;
                ...
                if (applyOnBootSet.contains(getString(R.string.gpu))) {
                    String max, min, gov;
